...
\subsection{Un poco sobre mi}
Tengo 17 años y quiero estudiar Ciencias de la Computacion


\subsection{Hobbies}
\begin{enumerate}
\item Fotball americano
\item Videojuegos
\item caminar
  \end {enumerate}
...
\begin{figure}[h]
  ...
  \includegraphics[escale=0.5]{Descargas/circulo.jpg}
  \caption{Es un circulo}
